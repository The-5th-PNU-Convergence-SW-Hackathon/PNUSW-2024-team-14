...
|요구사항|설명|
|:---:|:---:|
|사용자 친화적인 환경|대부분의 소비자가 생소한 전자 거래를 간단하게 제공해야한다|
||내 전자계좌에 남은 잔액을 확인할 수 있다|| 
|결제 내역 확인|결제 내역과 남은 회원권 기간을 확인할 수 있다|
...
### 1.5. 사회적가치 도입 계획
#### I. 헬스장 피해 인원 대폭 감소 
> 기존 매년 증가하던 헬스장 사기 피해 구제 건수를 대폭 줄일 수 있음. 소비자의 대금을 블록체인 네트워크 상에 보관하는 만큼, 헬스장의 폐업만 확인이 되면 확정적으로 환불됨. 
#### II. 건강한 구조의 피트니스 문화 
> 사전영업이 성행하는 기존의 피트니스 창업 문화에 긍정적인 영향을 줄 것. 소비자로부터 일시불로 받던 대금을 분할로 납부받게되고, 자금 안정성이 부실한 업체는 애초에 버칠 수 없음  
#### III. 다른 사업 분야 
